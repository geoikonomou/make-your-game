...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function showScreen(screenName) {
        ...
        if (screenName === 'menu') {
            ...
            document.getElementById('currentLevel').textContent = audioManager.settings.selectedLevel;
        }
    }
    ...
    levelButtons.forEach(function(btn) {
        btn.addEventListener('click', function() {
            audioManager.settings.selectedLevel = parseInt(this.getAttribute('data-level'));
            audioManager.playSfx('gameStart');
            showScreen('game');
        });
    });
